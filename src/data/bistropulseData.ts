...
export const LAYERS = [
  ...
  },
  {
    id: 'layer-3',
    name: 'Customers',
    description: 'Customer list, add customer, edit customer (dirty tracking), view customer, disable/enable.',
    color: '#f59e0b',
  },
  {
    id: 'layer-4',
...
export const FEATURES = [
  ...
  // ── LAYER 3 — Customers ─────────────────────────────────────
  {
    ...
    timeSpentHours: null,
    notes: 'GET /customers/?page=1&page_size=10. Paginated, search by name, CSV export. Dropdown: View navigates to /:id/view, Edit navigates to /:id/edit, Disable/Enable calls PATCH /customers/:id/ with {is_active}. Label flips dynamically based on customer.is_active.',
  ...
  // ── LAYER 4 — Food & Menu ───────────────────────────────────
  {
    ...
    completedAt: '2026-03-28',
    timeSpentHours: null,
    notes: 'GET /restaurants/:id/foods/ via FoodService.getFoods(). Handles paginated or plain array response. Maps API fields: id/food_id, name, category_name, price (parsed as float), is_available/available, image/photo_url. Search by name via FilterByPipe. View/edit/delete dropdown per row.',
  ...
  },
  {
    ...
    completedAt: null,
    timeSpentHours: null,
    notes: 'Form exists. POST /restaurants/:id/foods/. FoodService.createFood() detects FormData vs JSON and sets Content-Type accordingly. Needs end-to-end verification.',
  ...
  },
  {
    ...
    completedAt: null,
    timeSpentHours: null,
    notes: 'Page exists. Needs real API wiring to view and edit a specific food item.',
